  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:description', name: 'og:description', property:'og:description', 
        content: 'CG.Lee`s personal blog created with JAMStack Nuxt.js', 'template': chunk => `${chunk} - Blog `},
      ...
      { hid: 'twitter:description', name: 'twitter:description', property:'twitter:description' , content: 'CG.Lee`s personal blog created with JAMStack Nuxt.js' },        
